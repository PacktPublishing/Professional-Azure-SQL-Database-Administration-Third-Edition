...
$geodb = Get-AzSqlDatabaseGeoBackup -ServerName $sqlserver -DatabaseName $database -ResourceGroupName $resourcegroupname
...
$restore = Restore-AzSqlDatabase -FromGeoBackup -ResourceGroupName $resourcegroupname -ResourceId $geodb.ResourceID -ServerName $sqlserver -TargetDatabaseName $newdatabasename -Edition "Standard" -ServiceObjectiveName "S2"
